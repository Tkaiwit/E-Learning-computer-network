  ...
  <div>
    <div class="col-sm-3">
      <ul class="ul-menu well">
        ...
        <!-- <li><a href="addchstudent.php">เพิ่มบทเรียนให้นักศึกษา</a></li> -->
    ...
    <div class="detal-b col-sm-6 well">
          <h2 align="center">เพิ่มบทเรียน</h2><hr>
         <form name="form1" method="post" action="insert/insertch.php">
          <div class="text-log">
          <i class="fa fa-address-card" aria-hidden="true"></i> <label>รหัสบทเรียน</label>
        <input name="txtunitID" class="form-control" type="text" id="txtunitID" placeholder="กรุณกรอกชื่อบทเรียน..." required="">
        </div>
        <div class="text-log">
          <i class="fa fa-address-card" aria-hidden="true"></i> <label>ชื่อบทเรียน</label>
        <input name="txtunitName" class="form-control" type="text" id="txtunitName" placeholder="กรุณกรอกชื่อบทเรียน..." required="">
        </div><br>
        <div class="bt-log" align="center">
          <input class="btn btn-success run" type="submit" name="Submit" value="บันทึกบทเรียน">
        </div>
      </form>
