...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหานักศึกษาเพื่อลบ</h2><hr>
...
<style>
  ...
  <form name="form1">
    <tr>
    <td>
      <div align="center"><?php echo $objResult["studentID"];?>
      <input hidden="" name="studentID" id="studentID" type="text" value="<?php echo $objResult["studentID"];?>">
      </div>
    </td>
    <td><?php echo $objResult["firstName"];?>
    <input type="text" hidden="" name="firstName" value="<?php echo $objResult["firstName"];?>"></td>
    <td><?php echo $objResult["lastName"];?>
    <input type="text" hidden="" name="lastName" value="<?php echo $objResult["lastName"];?>">
    </td>
    <td><div align="center"><?php echo $objResult["pin_id"];?>
    <input type="text" hidden="" name="pin_id" value="<?php echo $objResult["pin_id"];?>">  
    </div></td>
    <td><div align="center"><a type="submit" onclick="return checkDelete(<?php echo $objResult['studentID'];?>, '<?php echo $objResult["firstName"];?>', '<?php echo $objResult['lastName'];?>',<?php echo $objResult['pin_id'];?>)" style="color: #000; "><i class="fa fa-trash" style="font-size: 15px;"></></i></a></div></td>
    </tr>
  <?php
  }
  ?>
...
<script type="text/javascript">
  function checkDelete(student_id, firstName, lastName, pin_id){
    alertify.confirm('<b>คุณต้องการลบข้อมูลของ</b><hr />','รหัสนักศึกษา '+student_id+' ชื่อ-นามสกุล '+firstName+' '+lastName+' รหัสบัตรประชาชน '+pin_id,
      function(){
        alertify.success('Ok');
        window.location.href = "delete/deletestudents.php?id=" + student_id;
      },
      function(){
