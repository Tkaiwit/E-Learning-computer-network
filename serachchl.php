  ...
  <div>
    <div class="col-sm-3">
      <ul class="ul-menu well">
        ...
        <li><a href="searchchl.pheditchl.php">แก้ไขแบบทดสอบ</a></li>
        <li><a href="dropchl.php">ลบแบบทดสอบ</a></li>
      </ul>
    </div>
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหาบททดสอบก่อนเรียน</h2><hr>
...
<style>
  ...
  <table width="100%">
    ...
    <th width="97"> <div align="center">เรื่องบทเรียน</div></th></tr>
  <?php
  while($objResult = mysql_fetch_array($objQuery))
  {
  ?>
    <tr>
    <td><div align="center"><?php echo $objResult["test_id"];?></div></td>
    <td><?php echo $objResult["test_name"];?></td>
    <td>
      <?php 
