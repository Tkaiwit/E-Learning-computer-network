...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well" style="background-color: #0E9995">
      <h1 align="center" style="color: #fff;">บททดสอบ</h1><hr>

       <?php 
      $sqlt = "SELECT * FROM testunit";
      $ras = mysql_query($sqlt);
      while ($cha=mysql_fetch_array($ras)) {
       for ($i=0; $i <$cha['test_id']; $i++) { 
      ?>
        <h3><a href="chl<?php echo $i+1 ?>.php" ><?php }?><?php echo $cha['test_name'];?></a></h3>
      <?php } ?>
