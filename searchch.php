...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหาบทเรียน</h2><hr>
...
<style>
  ...
  <table width="100%">
    ...
    <th width="80%"> <div align="center">ชื่อบทเรียน</div></th>
    </tr>
  <?php
  ...
  ?>
    <tr>
    <td width="20%"><div align="center"><?php echo $objResult["unitID"];?></div></td>
    <td width="80%"><?php echo $objResult["unitName"];?></td>
    </tr>
  <?php
  }
  ?>
