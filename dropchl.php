...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหาบททดสอบเพื่อลบ</h2><hr>
...
if(!$db){
  ...
  $strSQL = "SELECT * FROM testunit WHERE (test_name LIKE '%".$_GET["txtKeyword"]."%' or test_id LIKE '%".$_GET["txtKeyword"]."%' )";
...
<style>
  ...
  <table width="100%">
    <tr>
    <th width="60"> <div align="center">รหัสบททดสอบก่อนเรียน</div></th>
    <th width="98"> <div align="center">ชื่อบททดสอบก่อนเรียน</div></th>
    <th><div align="center">เรื่องบทเรียน</div></th>
    <th width="97"> <div align="center">จัดการ</div></th></tr>
  ...
  <form name="form1">
    <tr>
    <td>
      <div align="center"><?php echo $objResult["test_id"];?>
      <input hidden="" name="txtunitID" id="txtunitID" type="text" value="<?php echo $objResult["test_id"];?>">
      </div>
    </td>
    <td><?php echo $objResult["test_name"];?>
    <input type="text" hidden="" name="txtunitName" value="<?php echo $objResult["test_name"];?>">
  </td>
  <td><?php echo $objResult["unitID"];?>
    <input type="text" hidden="" name="txtunitName" value="<?php echo $objResult["unitID"];?>">
  </td>
    <td><div align="center"><a type="submit" onclick="return checkDeletee(<?php echo $objResult['test_id'];?>, '<?php echo $objResult["test_name"];?>',<?php echo $objResult["unitID"];?>)" style="color: #000; "><i class="fa fa-trash" style="font-size: 15px;"></></i></a></div></td>
    </tr>
  <?php
  }
  ?>
...
<script type="text/javascript">
  function checkDeletee(test_id,test_name, unitID){
    alertify.confirm('<b>คุณต้องการลบข้อมูลของ</b><hr />','<b>รหัสบททดสอบ</b> '+test_id+' <b>ชื่อบททดสอบ </b>'+test_name,
      function(){
        alertify.success('Ok');
        window.location.href = "delete/deletetestunit.php?id=" + test_id;
      },
      function(){
