  ...
  <div>
    ...
    <?php }} ?>
		...
		<div class="detal-b col-sm-6 well" >
			<label><h3><b>คำอธิบายรายวิชา</b></h3></label><br>
			<label>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ศึกษาและปฏิบัติเกี่ยวกับหลักการทำงานและองค์ประกอบของระบบเครือข่าย อุปกรณ์ระบบเครือข่าย ประเภทของเครือข่าย ตัวกลางการเชื่อมต่อเครือข่าย  โปรโตคอล รูปแบบการเชื่อมต่อเครือข่ายการติดตั้งระบบปฏิบัติการเครือข่ายใช้โปรแกรมประยุกต์และโปรแกรมยูลิตี้บนเครือข่าย
			</label>
			<label><h3><b>จุดประสงค์รายวิชา</b></h3></label><br>
			<label>
				1.	มีความรู้ความเข้าใจเกี่ยวกับหลักการทำงานและองค์ประกอบของระบบเครือข่าย<br>
				2.	เลื้อกใช้อุปกรณ์และเชื่อมต่อระบบเครือข่ายเบื้องต้น<br>
				3.	ประยุกต์ใช้งานเครือข่ายในองค์กร<br>
				4.	มีคุณธรรม จรอยธรรม และค่านิยมที่ดีในการใช้อมพิวเตอร์
			</label><br>
			<label><h3><b>สมรรถนะรายวิชา</b></h3></label><br>
			<label>
				1.	แสดงความรู้เกี่ยวกับหลักการทำงานและกระบวนการของระบบเครือข่าย<br>
