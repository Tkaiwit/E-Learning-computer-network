...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหาบทเรียนเพื่อแก้ไข</h2><hr>
...
<style>
  ...
  ?>
    ...
    <td><div align="center"><a href="unitedit.php?sid=<?php echo $objResult["unitID"];?>" style="color: #000; "><i class="fa fa-pencil-square-o" style="font-size: 15px;"></i></a></div></td>
    </tr>
  <?php
  }
  ?>
