...
<div class="container">
  <div>
    ...
    <div class="detal-b col-sm-6 well">
      <h2 align="center">ค้นหาบทเรียนเพื่อลบ</h2><hr>
        <form name="frmSearch" method="get" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
          <table width="100%" border="0s">
              <tr>
                <th>
                <input name="txtKeyword" type="text" id="txtKeyword" value="" placeholder="กรอกรหัสบทเรียน หรือ ชื่อบทเรียน...." style="width: 88%;">
...
<style>
  ...
  <table width="100%">
    <tr>
    <th width="60"> <div align="center">รหัสบทเรียน</div></th>
    <th width="98"> <div align="center">ชื่อบทเรียน</div></th>
  ...
  <form name="form1">
    <tr>
    <td>
      <div align="center"><?php echo $objResult["unitID"];?>
      <input hidden="" name="txtunitID" id="txtunitID" type="text" value="<?php echo $objResult["unitID"];?>">
      </div>
    </td>
    <td><?php echo $objResult["unitName"];?>
    <input type="text" hidden="" name="txtunitName" value="<?php echo $objResult["unitName"];?>">
  </td>
    <td><div align="center"><a type="submit" onclick="return checkDeletee(<?php echo $objResult['unitID'];?>, '<?php echo $objResult["unitName"];?>')" style="color: #000; "><i class="fa fa-trash" style="font-size: 15px;"></></i></a></div></td>
    </tr>
  <?php
  }
  ?>
...
<script type="text/javascript">
  function checkDeletee(unit_ID, unit_Name){
    alertify.confirm('<b>คุณต้องการลบข้อมูลของ</b><hr />','รหัสบทเรียน '+unit_ID+' ชื่อบทเรียน '+unit_Name,
      function(){
        alertify.success('Ok');
        window.location.href = "delete/deleteunit.php?id=" + unit_ID;
      },
      function(){
